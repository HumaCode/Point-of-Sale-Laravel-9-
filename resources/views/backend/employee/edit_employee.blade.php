    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"><i class="mdi mdi-pencil me-1"></i> Edit Employee</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('experience') is-invalid @enderror"
                                            ...
                                            <option value="3 Year" {{ $employee->experience == '3 Year' ? 'selected' :
                                                '' }}>3 Year</option>
                                            <option value="4 Year" {{ $employee->experience == '4 Year' ? 'selected' :
                                                '' }}>4 Year</option>
                                            <option value="5 Year" {{ $employee->experience == '5 Year' ? 'selected' :
                                                '' }}>5 Year</option>
                                        </select>
                                        @error('experience')
                                        <span class="text-danger">{{ $message }}</span>
