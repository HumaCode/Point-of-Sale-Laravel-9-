                    ...
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('add.advance.salary') }}"
                            class="btn btn-primary rounded-pill waves-effect waves-light"><i
                                class="mdi mdi-plus me-1"></i> Add Advance Salary</a>

                    </div>
                    <h4 class="page-title"><i class="mdi mdi-cash-usd-outline me-1"></i> Last Month Salary</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-blue">Full Paid</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('edit.advance.salary', $item->id) }}"
                                            class="btn btn-primary rounded-pill waves-effect waves-light"><i
                                                class="mdi mdi-history me-1"></i> History</a> &nbsp;
