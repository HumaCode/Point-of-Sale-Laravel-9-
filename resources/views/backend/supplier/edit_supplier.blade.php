    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"><i class="mdi mdi-plus me-1"></i> Edit Supplier</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" id="name" value="{{ old('name', $supplier->name) }}">
                                        @error('name')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_name"
                                            ...
                                            id="bank_name" value="{{ old('bank_name', $supplier->bank_name) }}">
                                        @error('bank_name')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_branch"
                                            ...
                                            id="bank_branch" value="{{ old('bank_branch', $supplier->bank_branch) }}">
                                        @error('bank_branch')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('type') is-invalid @enderror" id="type"
                                            ...
                                            <option value="Distributor" {{ $supplier->type == 'Distributor' ? 'selected'
                                                : '' }}>Distributor</option>
                                            <option value="Whole Seller" {{ $supplier->type == 'Whole Seller' ?
                                                'selected' : '' }}>Whole Seller</option>
                                        </select>
                                        @error('type')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
