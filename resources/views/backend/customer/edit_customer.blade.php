    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title"><i class="mdi mdi-pencil me-1"></i> Edit Customer</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_name"
                                            ...
                                            id="bank_name" value="{{ old('bank_name', $customer->bank_name) }}">
                                        @error('bank_name')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bank_branch"
                                            ...
                                            id="bank_branch" value="{{ old('bank_branch', $customer->bank_branch) }}">
                                        @error('bank_branch')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
